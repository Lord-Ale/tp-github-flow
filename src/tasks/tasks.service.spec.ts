...
describe('TasksService', () => {
  ...
  // TODO (Partie 2 — GitHub Flow) : implémenter findFiltered(done: boolean)
  // dans TasksService, puis adapter ce test pour vérifier le filtrage.
  //
  // describe('findFiltered', () => {
  //   it('retourne uniquement les tâches dont done correspond au filtre', async () => {
  //     ...
  //   });
  // });
});
